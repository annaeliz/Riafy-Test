...
CREATE TABLE `stock` (
  ...
  `Current Market Price` varchar(20) NOT NULL,
  `Market Cap` varchar(10) NOT NULL,
  `Stock P/E` varchar(9) NOT NULL,
  `Dividend Yield` varchar(14) NOT NULL,
  `ROCE %` varchar(6) NOT NULL,
  `ROE Previous Annum` varchar(18) NOT NULL,
  `Debt to Equity` varchar(14) NOT NULL,
  `EPS` varchar(5) NOT NULL,
  `Reserves` varchar(8) NOT NULL,
  `Debt` varchar(6) NOT NULL
...
INSERT INTO `stock` (`S.No.`, `Name`, `Current Market Price`, `Market Cap`, `Stock P/E`, `Dividend Yield`, `ROCE %`, `ROE Previous Annum`, `Debt to Equity`, `EPS`, `Reserves`, `Debt`) VALUES
